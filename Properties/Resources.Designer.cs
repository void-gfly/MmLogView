namespace MmLogView.Properties {
    ...
    public class Resources {
        ...
        public static string JsonEditDialogTitle => ResourceManager.GetString("JsonEditDialogTitle", resourceCulture)!;
        public static string JsonEditHint => ResourceManager.GetString("JsonEditHint", resourceCulture)!;
        public static string JsonEditInvalidInput => ResourceManager.GetString("JsonEditInvalidInput", resourceCulture)!;
        public static string JsonEditNodeLabel => ResourceManager.GetString("JsonEditNodeLabel", resourceCulture)!;
        public static string JsonEditStringFooterHint => ResourceManager.GetString("JsonEditStringFooterHint", resourceCulture)!;
        public static string JsonEditTypedFooterHint => ResourceManager.GetString("JsonEditTypedFooterHint", resourceCulture)!;
        public static string JsonEditTypeLabel => ResourceManager.GetString("JsonEditTypeLabel", resourceCulture)!;
        ...
        public static string MenuEditNode => ResourceManager.GetString("MenuEditNode", resourceCulture)!;
